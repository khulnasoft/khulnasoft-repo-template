...
# LICENSE:       see in ../LICENSE (project root) or https://github.com/khulnasoft/khulnasoft-repo-template/blob/master/LICENSE
# GITHUB:        https://github.com/khulnasoft/
# REPOSITORY:    https://github.com/khulnasoft/khulnasoft-repo-template
# ISSUES:        https://github.com/khulnasoft/khulnasoft-repo-template/issues
# MAIL:          info@khulnasoft.com
#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#
...
displayTestErrorTexts() {
  ...
  echo -e "Remember that your brand new repository should be created from here: ${BOLD}${UPURPLE}https://github.com/khulnasoft/khulnasoft-repo-template/generate${NC}"
...
displayHelpTexts() { # (it will manually detect your git data and prompt for the project type)
  ...
  echo -e "  bash $0 --email=info@khulnasoft.com"
  echo -e "  bash $0 --username=whatever --projectName=whatever --email=whatever --projectType=whatever${NC}"
  echo -e "  bash $0 -u=khulnasoft --projectType=Github-template --omit-commit${NC}\n"

  echo -e "The username, project-name and email are automatically gathered from your git repository and git config."
  echo -e "Make sure you have ${BBLUE}read the documentation before executing${NC} this script: ${UPURPLE}https://github.com/khulnasoft/khulnasoft-repo-template${NC}"
  echo -e "If you have any questions or if any issue is found, please make sure to report it at: ${UPURPLE}https://github.com/khulnasoft/khulnasoft-repo-template/issues${NC}"
}
...
$PROJECT_NAME was generated from *[khulnasoft/khulnasoft-repo-template](https://github.com/khulnasoft/khulnasoft-repo-template)* 📚
...
* The basic project structure from **[khulnasoft/khulnasoft-repo-template](https://github.com/khulnasoft/khulnasoft-repo-template)**.
EOF"
}
